            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown ">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="glyphicon glyphicon-user"></i> Користувачі <span class="caret"></span></a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ url('/home/user') }}">Всі користувачі</a></li>
                                <li><a href="{{ url('/home/user/create') }}">Створити нового користувача</a></li>
                            </ul>
                        </li>
                        @endif
